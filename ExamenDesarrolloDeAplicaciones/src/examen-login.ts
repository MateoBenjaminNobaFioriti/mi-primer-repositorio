...
//Interface del usuario para tener una estructura de como van a ser los datos de los usuarios.
interface Usuario{
    id: number,
    nombre: string,
    email: string,
...
function encontrarMail(mailUsuario: string){
...
function validarPassword(passwordUsuario: string){
